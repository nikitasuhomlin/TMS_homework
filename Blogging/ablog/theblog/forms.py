...
class PostForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'title': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter the title name'}),
            'title_tag': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter the title tag'}),
            'author': forms.TextInput(attrs={'class': 'form-control', 'value': '', 'id': 'suhomlin', 'type':'hidden'}),
